    ...
    return (
        <>
            ...
            <div className="flex justify-around items-center mb-12">
                <div>
                    <img src="/src/assets/icones/react.svg" alt="icone competence" className="h-14"/>
                    <div className="mt-2">REACT.JS</div>
                </div>
                <div>
                    <img src="/src/assets/icones/tailwindcss-icon.svg" alt="icone competence" className="h-14"/>
                    <div className="mt-2">TAILWIND</div>
                </div>
                <div>
                    <img src="/src/assets/icones/nodejs-icon.svg" alt="icone competence" className="h-14"/>
